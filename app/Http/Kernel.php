...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'check_if_can_view_vacation' => \App\Http\Middleware\CheckIfCanViewVacation::class,
        'not_client' => \App\Http\Middleware\NotClient::class,
        'check_if_can_view_report' => \App\Http\Middleware\CheckIfCanViewReport::class,
